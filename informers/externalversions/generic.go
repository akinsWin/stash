...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=Apis, Version=Stash
	case stash.SchemeGroupVersion.WithResource("restics"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Apis().Stash().Restics().Informer()}, nil

		// Group=Stash, Version=V1alpha1
