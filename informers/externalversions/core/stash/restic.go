...
import (
	api_stash "github.com/appscode/stash/apis/stash"
	...
	stash "github.com/appscode/stash/listers/core/stash"
	...
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.CoreStash().Restics(v1.NamespaceAll).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.CoreStash().Restics(v1.NamespaceAll).Watch(options)
			},
		},
		&api_stash.Restic{},
		resyncPeriod,
...
func (f *resticInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&api_stash.Restic{}, newResticInformer)
}
